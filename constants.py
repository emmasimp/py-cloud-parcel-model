...
'test': [1770,2560,2,0.6],                'sea salt': [58.44e-3, 2160, 2, 1.28],
                ...
                'test':[1,1,1,1],
                'SV01': [200e-3, 1500, 1, 0.067, 150e3],
                'SV02': [200e-3, 1500, 1, 0.067, 150e3],
                'SV03': [200e-3, 1500, 1, 0.067, 150e3]}
                #'Contents' :['molecular weight (kg/mol)','density (kg/m3)'
                           #  ,'nu','kappa']}

semi_vol_dict = {'SV01': [200e-3, 1500, 1, 0.067, 150e3],
                 'SV02': [200e-3, 1500, 1, 0.067, 150e3],
                 'SV03': [200e-3, 1500, 1, 0.067, 150e3]}
# Contents: molecular weight, density, nu, log10_CSTAR, DELTA_H_VAP 